      ...
      <main className="min-h-screen">
        ...
        <div>
          <section className="pb-[120px]">
            <div className="max-w-full sm:max-w-[720px] md:max-w-[960px] xl:max-w-[1320px] mx-auto px-4 container">
              {/* Address & Contact */}
                ...
                <div className="flex flex-row flex-wrap items-center justify-between">
                  <div className="px-3 sm:w-[33%]">
                    <div className="p-[40px_30px] text-center space-y-4">
                      ...
                      <div className="flex items-center justify-center">
                        <ICONS.MAP className="w-16 h-16 md:w-24 md:h-24 text-suxnix-text_secondary" />
                      </div>
                  ...
                  <div className="px-3 sm:w-[33%]">
                    <div className="p-[40px_30px] text-center space-y-4">
                      {/* icon */}
                      <div className="flex items-center justify-center">
                        <ICONS.PHONE className="w-16 h-16 md:h-24 md:w-24 text-suxnix-text_secondary" />
                      </div>
                  ...
                  <div className="px-3 sm:w-[33%]">
                    <div className="p-[40px_30px] text-center space-y-4">
                      {/* icon */}
                      <div className="flex items-center justify-center">
                        <ICONS.BROWSER className="w-16 h-16 md:h-24 md:w-24 text-suxnix-text_secondary" />
                      </div>
              ...
              <div>
                <div className="flex flex-col items-center justify-between gap-10 xl:items-start xl:flex-row xl:gap-0">
                  ...
                  <div className="w-full xl:w-[50%] px-3">
                    <div className="xl:pl-[30px] space-y-7">
                      {/* title */}
                      <div className="space-y-5 text-center xl:text-start">
                        <p className="text-base font-medium uppercase text-suxnix-text_primary">
                          .. request make ..
                        </p>
                          ...
                          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                            ...
                            <div className="col-span-2 px-2 space-y-2 md:col-span-1">
                              ...
                              <Input
                                ...
                                name="username"
                                id="username"
                                className="!text-base font-normal rounded-sm text-suxnix-text_heading p-7"
                            ...
                            <div className="col-span-2 px-2 md:col-span-2">
                              <Select className="">
                                ...
                                <SelectContent>
                                  <SelectGroup className="!text-base font-normal rounded-sm text-suxnix-text_heading">
